...
function BooksList() {
  const books = [
    ...
    },
    {
      id: 4,
      img: Trickster,
      url: "https://www.amazon.ca/Trickster-Raven-Trail-Gitchee-Gami-Baynton/dp/1039183603/ref=sr_1_2?dib=eyJ2IjoiMSJ9.iMyu9tEBRWm23_mLk6mQP8WUjfw_oqcVJ8YkiKhyrYRK4kdq5zzTeG9Vn1DH3Qnk.sKmuxLUJGdkZDdB85t760btJ-Op45XC9rsyjW6V4wo0&dib_tag=se&qid=1708390924&refinements=p_27%3ABrian+Baynton&s=books&sr=1-2&text=Brian+Baynton",
    },
  ];

  const myBooks = books.map((book) => {
    return <Book key={book.id} id={book.id} img={book.img} url={book.url} />;
  });

  return <div className="bookslist">{myBooks}</div>;
}
